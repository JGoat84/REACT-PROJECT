...
export const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_wl8zovd', 'template_f75tjl9', form.current, 'user_go3vQgao3KpvFkIvBMSRq')
      .then((result) => {
...
<form ref={form} onSubmit={sendEmail}>
                <div class="card">
                <h2>Under 18 Photo release Waiver</h2>
              ...
              <label> As the parent or legal guardian of the Model I agree to the above waiver consent and terms of use</label>
              <input type="checkbox"/>
              </div>
          </div>
        ...
        <br/>
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" name="Parent_Surname"/>
            </div>
          </div>
